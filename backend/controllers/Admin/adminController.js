...
export const getDashboardStats = async (req, res) => {
  try {
    ...
    // New Gym-specific stats
    const pendingMemberships = await MembershipPurchase.countDocuments({ paymentStatus: 'pending' });
    const activeMemberships = await MembershipPurchase.countDocuments({ membershipStatus: 'active' });
    const pendingStoreOrders = await StoreOrder.countDocuments({ orderStatus: 'pending' });
