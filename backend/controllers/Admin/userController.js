...
export const updateProfile = async (req, res) => {
  try {
    const { 
      username, firstName, lastName, phoneNumber, dateOfBirth, address,
      gender, height, currentWeight, targetWeight, fitnessGoal, trainingLevel,
    ...
    if (dateOfBirth !== undefined) updateData.dateOfBirth = dateOfBirth; // Allow null
...
export const updateProfilePicture = async (req, res) => {
  try {
    // Accept either a JSON URL in body.profileImage or an uploaded file (req.file)
